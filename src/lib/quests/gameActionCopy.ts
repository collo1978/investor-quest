/**
 * Canonical player action labels — use everywhere (no variants).
 */

export const MARK_AS_READ_LABEL = "Mark as Read";
/** Quick-reveal CTA on quest cards (e.g. `/business/what-they-do`). */
