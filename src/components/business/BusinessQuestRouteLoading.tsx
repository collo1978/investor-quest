/**
 * Shown while /business/[questSlug] compiles or loads (Next.js loading.tsx).
 * Gives immediate feedback so the hub does not feel frozen after a card click.
 */
export function BusinessQuestRouteLoading() {
  return (
    <main
