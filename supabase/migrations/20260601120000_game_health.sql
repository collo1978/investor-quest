-- Game health monitoring: scheduled checks, issues, alert settings.
...
create policy "game_health_checks_select" on public.game_health_checks for select using (true);
create policy "game_health_checks_insert" on public.game_health_checks for insert with check (true);

create policy "game_health_issues_select" on public.game_health_issues for select using (true);
create policy "game_health_issues_insert" on public.game_health_issues for insert with check (true);
create policy "game_health_issues_update" on public.game_health_issues for update using (true);

create policy "game_health_settings_select" on public.game_health_settings for select using (true);
create policy "game_health_settings_update" on public.game_health_settings for update using (true);
